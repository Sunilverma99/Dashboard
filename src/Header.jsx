...
function Header() {
  return (
    <nav class="bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700 px-96">
  <div class="max-w-screen-xl flex flex-wrap items-end justify-between mx-auto p-4">
    ...
    <div class="hidden w-full md:block md:w-auto" id="navbar-multi-level item-end">
